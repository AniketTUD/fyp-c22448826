...
import static com.chatbot.utils.OllamaImage.LLAMA_3_1;
import static com.chatbot.utils.OllamaImage.localOllamaImage;

public class AbstractOllamaInfrastructure {

    public static final String OLLAMA_BASE_URL = System.getenv("http://localhost:11434");
